...
public class Functions {
	...
	private static Integer getReg(String reg) {
		if(reg.startsWith("r")) {
	...
	private static Integer getIm(String im) {
		try {
	...
	private static int makeIns(String s, Integer r1, Integer r2, Integer r3, String e) {
		int n = 32-s.length();
		if(r1 != null)
			n -= 5;
		if(r2 != null)
	...
	private static String makeReg(Integer r, int n) {
		if(r == null)
			return "";
	...
	public static Integer compile(String ins) {
